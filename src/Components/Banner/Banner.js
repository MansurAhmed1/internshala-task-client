    ...
    <div className="lg:grid  flex  flex-col-reverse lg:grid-cols-2 grid-cols-1 w-11/12 mx-auto py-5">
      <div className="px-5 bannermain ">
        ...
        <p className="py-4 text-justify text-black ">
          Good CAr will make your future very beautiful. You do not have
          to buy the car again and again. So you can save your money and
          get a good car at a comfortable price.You will find all kinds of BK
          pages on our website very easily. If there is a problem with any
          equipment within 2 months, we will at least warrenty it. You will not
